...
import { ArticleImageDropzoneUi } from "components/add-post-ui/article-image-dropzone-ui";
          ...
          {!state.src && (
            <FileUploader
              ...
              children={
                !isNewUi ? (
                  isArticleFormUi ? (
                    <ArticleImageDropzoneUi  text={`${lang("DASHBOARD.UPLOAD_TITLE")} (Size 870 X 344 or 1244 X 492 or 1617 X 640 / JPG, PNG)`} />
                  ) : (
