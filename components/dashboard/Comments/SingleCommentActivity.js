...
******************/
  const ReplyPost = async (e) => {
    ...
    const descriptionTag = description.includes("~+~")
      ? description.split("~+~")[0] + "$$$~~~"
      : description;
    description = descriptionTag.split("$$$__").join('<a href="/profile/');
...
******************/
  const handleEditReplyComments = (e, cmntData) => {
    ...
    const descriptionTag = description1.includes("~+~")
      ? description1.split("~+~")[0] + "$$$~~~"
      : description1;
    description1 = descriptionTag.split('<a href="/profile/').join("$$$__");
    description1 = description1.split(`">`).join("~~~__");
    description1 = description1.split("</a>").join("$$$~~~");
...
export default SingleCommentActivity;
