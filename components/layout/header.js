...
import { Box, Container, Avatar, Card, Link as MuiLink } from "@mui/material";
...
******************/
  ...
  ******************/
  ...
  return (
    <header>
      <Box sx={{ boxShadow: 2 }} className="header-box">
        <Grid
          container
          maxWidth="1160px"
          marginLeft={"auto"}
              ...
              >
                <Link route={DASHBOARD}>
                  ...
                  >
                    <HeaderLabel
                      role="button"
                      className={
                        props.router.pathname === DASHBOARD && "active"
                      }
                      handleClick={() =>
                        setCookie("postToken", postTokenUnix(new Date()))
                      }
                ...
                <Link route={TOPIC}>
                  <a
                    role="button"
                    className={
                      props.router.pathname === TOPIC
                        ? "menu-item active"
                        : "menu-item"
                    }
                  >
                    <HeaderLabel
                      className={props.router.pathname === TOPIC && "active"}
                      target={props?.isJoinRoom ? "_blank" : undefined}
                      labelText={lang("HEADER.TOPICS")}
                    />
                  </a>
                  {/* <a
                  role="button"
