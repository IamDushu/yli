  ...
  if (!file) {
    return (
      <Modal
        open={true}
        onClose={onCancel}
        className="image-editor-select-modal"
      >
        <div className="image-editor-select-modal-container">
          <div className="image-editor-select-modal-header">
            <span>Drag or Upload an Image</span>
          </div>
          <div className="file-drag-select">
            <FileDropzone onChange={e => onImageLoad(e)} />
          </div>
        </div>
      </Modal>
    );
