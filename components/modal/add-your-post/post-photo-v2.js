...
export const PhotoPostV2 = ({
  ...
  ******************/
  ...
  const handlePopoverClose = () => setPopoverVisible(false);
  ...
  return (
    <div className="image-editor-wrapper">
      <Modal
        ...
        title={null}
        footer={file && <div className="image-editor-modal-footer">
          <Button onClick={onReset} size="large">Reset</Button>
          <Button type="primary" onClick={onUpload} size="large">Done</Button>
        </div>}
      >
        <Row className="p-12 d-flex align-items-center justify-content-between image-editor-modal-header">
          ...
          <CloseCircleOutlined style={{ fontSize: '20px' }} onClick={onCancel} />
        </Row>
        <Row>
            ...
            <div ref={canvasWrapper} style={{ minHeight: maxCanvasSize.height + 5 }} className="preview-canvas-wrapper">
              <div className="canvas-tooltip-wrapper">
                <Popover
                  ...
                  style={{ top: `${canvasClickPositionRef.current.top}px`, left: `${canvasClickPositionRef.current.left}px` }}
                  placement="top"
                  className="select-user-pop-over"
                  content={
                    <SelectUser
                  ...
                  />
                  {
                    taggedUserData.map((taggedUser) => (
                      ...
                      >
                        ...
                        &nbsp;
                        <Icon onClick={() => onUserRemove(taggedUser.user.userId)} className="filter-sroll-icon-right" component={RemoveTaggedUser} />
                      </div>
                    ))
                  }
                </Popover>
          ...
          </Col>
          {
            file && <Col span={12} className="p-12">
              <Row className="mb-3 pb-3 image-editor-crop-wrapper">
                ...
                <Col span={24}>
                  <Button onClick={() => setSelectedAspectRatio(0)} size="small">Original</Button> &nbsp;
                  <Button onClick={() => setSelectedAspectRatio(1 / 1)} size="small">Square</Button> &nbsp;
              ...
              <Row className="mb-3 pb-3 d-flex image-editor-position-wrapper">
                ...
                <Col span={8}>
                  ...
                  <Slider
                    ...
                    value={zoomScale}
                    step={0.1}
                    onChange={(value) => setZoomScale(value)}
                    min={0}
                    max={2}
                  />
                </Col>
                <Col span={8}>
                  ...
                  <Slider
                    ...
                    value={rotationAngle}
                    step={1}
                    onChange={(value) => adjustRotateAngle(value)}
                    min={0}
                    max={360}
                  />
                </Col>
              ...
              <Row className="mb-3 pb-3 image-editor-optimization-wrapper">
                ...
                <Col span={8}>
                  ...
                  <Slider
                    ...
                    onChange={(value) => updateFilter(value, "brightnessSlider")}
                    min={0}
                    max={300}
                  />
                </Col>
                <Col span={8}>
                  ...
                  <Slider
                    ...
                    onChange={(value) => updateFilter(value, "contrastSlider")}
                    min={0}
                    max={200}
                  />
                </Col>
                <Col span={8}>
                  ...
                  <Slider
                    ...
                    onChange={(value) => updateFilter(value, "saturationSlider")}
                    min={0}
                    max={300}
                  />
                </Col>
