...
import { RejectRequest, Connect } from "components/svg/connections";
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        {list?.data?.length > 0 && (
          <p className="px-12">
            {`${list?.data?.length} ${lang("CONNECTIONS.RECORDS_FOUND")}`}
          </p>
        )}
        <Container fluid>
                    ...
                    <Card.Body className="d-flex flex-column h-100 p-0 pt-1 myconnection-body">
                      ...
                      <div className="text-gary font-medium mb-2 d-flex px-2">
                        ...
                        <Button
                          ...
                          variant="btn btn-outline-primary ml-1 btn-small-icon w-100"
                          onClick={() => rejectRequest(v.id)}
                        >
                          <RejectRequest />
