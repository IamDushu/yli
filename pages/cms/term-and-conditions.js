...
import { getTermsInfo } from "store/actions";
...
const TermAndConditions = () => {
  ...
  ******************/
  ...
  useEffect(() => {
    ...
    dispatch(getTermsInfo(currentLanguage));
  }, []);
  ...
  ******************/
  ...
  const { termsInfo } = useSelector(({ termscondiction }) => termscondiction);

  function createMarkup() {
    if (termsInfo.content) {
      return {
        __html: termsInfo.content,
      };
    }
  }
  ...
  ******************/
  return (
    <Layout>
      <div className="inner-wrapper bg-white terms-box">
        <Container>
